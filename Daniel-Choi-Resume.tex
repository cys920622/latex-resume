...
\usepackage[letterpaper,margin=0.75in,headheight=15mm,headsep=0mm]{geometry} % margins set to accept header
...
\begin{itemize}
	...
	\begin{itemize*}
		\item Expected graduation: Sept. 2017
		\item GPA 4.16 (in-major)
	\end{itemize*}
	...
	\begin{itemize*}
		\item Concentration in biochemistry \& human physiology
		\item GPA 3.98
	\end{itemize*}
\end{itemize}
